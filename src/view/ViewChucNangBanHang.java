...
public class ViewChucNangBanHang extends javax.swing.JFrame {
    ...
    private IGioHangService iGioHangService = new GioHangService();
    ...
    public ViewChucNangBanHang() {
        ...
        loadTableGioHang(iGioHangService.getAllGioHangChucNang());
 ...
 public void loadTableHoaDon(ArrayList<ViewModelHoaDon> list) {
        ...
        for (ViewModelHoaDon viewModelHoaDon : list) {
            defaultTableModel.addRow(new Object[]{
                stt++, viewModelHoaDon.getMa(), viewModelHoaDon.getNgayTao(), viewModelHoaDon.getTenNV(), getTinhTrang(viewModelHoaDon.getTinhTrang())
    ...
    private void txtTimKiemTheoTenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTimKiemTheoTenActionPerformed
        ...
        ArrayList<ViewModelChiTietSP> sanPham = iChiTietSPService.getFindByTen(searchByTenSanPham);
