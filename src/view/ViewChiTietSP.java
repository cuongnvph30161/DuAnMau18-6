...
public class ViewChiTietSP extends javax.swing.JFrame {
    ...
    public ISanPhamService iSanPhamService = new SanPhamService();
    public IMauSacService iMauSacService = new MauSacService();
    public IDongSPService iDongSPService = new DongSPService();
