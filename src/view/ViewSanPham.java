...
public class ViewSanPham extends javax.swing.JFrame {
    ...
    public void loadTable(List<ViewModelSanPham> list) {
        ...
        for (ViewModelSanPham viewModelSanPham : list) {
            defaultTableModel.addRow(new Object[]{
                viewModelSanPham.getMa(), viewModelSanPham.getTen(), viewModelSanPham.getId()
            }
            );
        }
    }
    ...
    public ViewModelSanPham getData() {
        ViewModelSanPham viewModelSanPham = new ViewModelSanPham();
        String ma = txtMa.getText();
        String ten = txtTen.getText();

        viewModelSanPham.setMa(ma);
        viewModelSanPham.setTen(ten);
        return viewModelSanPham;
    }


    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ViewModelSanPham viewModelSanPham = getData();
        JOptionPane.showMessageDialog(this, iSanPhamService.insert(viewModelSanPham));
        loadTable(iSanPhamService.getAll());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        String ma = tblSanPhamForm.getValueAt(row, 0).toString();
        JOptionPane.showMessageDialog(this, iSanPhamService.update(ma, viewModelSanPham));
        loadTable(iSanPhamService.getAll());
